...
namespace ResHub.Migrations
{
    ...
    [Migration("20240907170901_buses-second")]
    partial class busessecond
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResHub.Models.Bus", b =>
                {
                    ...
                    b.Property<string>("BusDriverPhoneNumber")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ResHub.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ResHub.Models.StudentResident", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ResHub.Models.DepartureTime", b =>
                {
                    b.HasOne("ResHub.Models.Bus", "Bus")
            ...
            modelBuilder.Entity("ResHub.Models.Message", b =>
                {
                    b.HasOne("ResHub.Models.StudentResident", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ResHub.Models.StudentResident", "Sender")
                        .WithMany()
